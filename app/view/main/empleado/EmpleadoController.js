Ext.define('MiAppSencha.view.empleado.EmpleadoController', {
    ...
    enviarDatos: function(){
        ...
        onEliminar: function(grid, rowIndex){
            ...
            Ext.Msg.confirm('Elimnar empleado', '¿Está seguro que desea eliminarlo definitivamente?', function(respuesta){
                if(respuesta==="yes"){
                    ...
                    Ext.Ajax.request({
                        ...
                        if(telefonos.length>0){
                            Ext.Msg.alert('No permitido', 'No se puede eliminar un empleado con telefono asociado')
